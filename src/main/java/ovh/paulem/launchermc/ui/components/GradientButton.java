package ovh.paulem.launchermc.ui.components;
...
public class GradientButton extends Button {
    ...
    public GradientButton(String text, double backgroundRadius, double scaleOnHover) {
        ...
        hoverProgress.addListener((obs, oldVal, newVal) -> {
            ...
            int r1 = lerp(GRADIENT_START.getRed(), GRADIENT_START_HOVER.getRed(), t);
            int g1 = lerp(GRADIENT_START.getGreen(), GRADIENT_START_HOVER.getGreen(), t);
            int b1 = lerp(GRADIENT_START.getBlue(), GRADIENT_START_HOVER.getBlue(), t);
            int r2 = lerp(GRADIENT_END.getRed(), GRADIENT_END_HOVER.getRed(), t);
            int g2 = lerp(GRADIENT_END.getGreen(), GRADIENT_END_HOVER.getGreen(), t);
            int b2 = lerp(GRADIENT_END.getBlue(), GRADIENT_END_HOVER.getBlue(), t);
     ...
     */
    private static int lerp(double from, double to, double t) {
